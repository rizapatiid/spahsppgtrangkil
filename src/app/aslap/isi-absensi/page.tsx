      ...
      {existingAbsensi ? (
        <div className="flex flex-col items-center justify-center py-16 px-4 text-center mt-4">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3 w-full sm:w-auto mt-2">
            <Link href="/aslap" className="flex items-center justify-center gap-2 bg-slate-900 text-white px-6 py-2.5 rounded-xl font-bold text-[14px] hover:bg-slate-800 transition-all shadow-sm w-full sm:w-auto active:scale-95">
              <Home size={18} />
              Kembali ke Beranda
            </Link>
            <Link href="/aslap/absensi" className="flex items-center justify-center gap-2 bg-white text-slate-700 border border-gray-200 px-6 py-2.5 rounded-xl font-bold text-[14px] hover:bg-gray-50 hover:border-gray-300 transition-all shadow-sm w-full sm:w-auto active:scale-95">
              <History size={18} />
              Cek Riwayat
            </Link>
          </div>
